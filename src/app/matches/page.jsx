              ...
              {conversations.length > 0 ? (
                <div className="flex flex-col">
                  {conversations.map(chat => (
                    <Link key={chat.id} href={`/matches/${chat.id}`} className="flex items-center gap-3 py-3 border-b border-[#F0F0F0] active:bg-[#F5F5F5] transition-colors rounded-lg -mx-2 px-2">
